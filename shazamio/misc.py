...
class ShazamUrl:
    SEARCH_FROM_FILE = (
        "https://amp.shazam.com/discovery/v5/en/{}/iphone/-/tag/{}/{"
    ...
    TOP_TRACKS_WORLD = (
        "https://www.shazam.com/shazam/v3/en/{}/web/-/tracks/ip-global-chart"
        "?pageSize={}&startFrom={}"
    )
    ARTIST_ABOUT = (
    ...
    TOP_TRACKS_COUNTRY = (
        "https://www.shazam.com/shazam/v3/en/{}/web/-/tracks/ip-country-chart-{}?pageSize={"
        "}&startFrom={}"
    )
    TOP_TRACKS_CITY = (
        "https://www.shazam.com/shazam/v3/en/{}/web/-/tracks/ip-city-chart-{}?pageSize={"
        "}&startFrom={}"
    )
    CITY_IDS = "https://raw.githubusercontent.com/dotX12/dotX12/main/city.json"
    GENRE_WORLD = (
        "https://www.shazam.com/shazam/v3/en/{}/web/-/tracks/genre-global-chart-{}?pageSize={"
        "}&startFrom={}"
    )
    GENRE_COUNTRY = (
        "https://www.shazam.com/shazam/v3/en/{}/web/-/tracks/genre-country-chart-{}-{}?pageSize={"
        "}&startFrom={}"
    )
    RELATED_SONGS = (
        "https://cdn.shazam.com/shazam/v3/en/{}/web/-/tracks/track-similarities-id-{}"
    ...
    SEARCH_MUSIC = (
        "https://www.shazam.com/services/search/v3/en/{}/web/search?query={}"
