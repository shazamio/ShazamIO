...
class ShazamUrl:
    SEARCH_FROM_FILE = 'https://amp.shazam.com/discovery/v5/en/GB/iphone/-/tag/{}/{}?sync=true&webv3=true' \
                       '&sampling=true&connected=&shazamapiversion=v3&sharehub=true&hubv5minorversion=v5.1&hidelb' \
                       '=true&video=v3'  # TESTED
    TOP_TRACKS_WORLD = 'https://www.shazam.com/shazam/v3/en/GB/web/-/tracks/ip-global-chart?pageSize={}&startFrom={}'  # TESTED
    ARTIST_ABOUT = 'https://www.shazam.com/discovery/v3/en/GB/web/artist/{}?shazamapiversion=v3&video=v3'  # TESTED
    ARTIST_TOP_TRACKS = 'https://cdn.shazam.com/shazam/v3/en/GB/web/-/tracks/artisttoptracks_{}?startFrom={}' \
                        '&pageSize={}&connected=&channel='  # TESTED
    ABOUT_TRACK = 'https://www.shazam.com/discovery/v5/en/GB/web/-/track/{}?shazamapiversion=v3&video=v3'  # TESTED
    ...
    RELATED_SONGS = 'https://cdn.shazam.com/shazam/v3/en/GB/web/-/tracks/track-similarities-id-{}' \
                    '?startFrom={}&pageSize={}&connected=&channel='  # TESTED
